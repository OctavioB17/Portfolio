      ...
      <Box sx={{width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', bgcolor: 'background.default', fontFamily: 'Proxima-Nova', padding: '2vw'}}>
          ...
          <Box sx={{display: 'flex'}}>
            <ImageList sx={{width: '100%'}} cols={ isSmallScreen ? 1 : 2} gap={100}>
                ...
                <ProjectBox sx={{borderRadius: isSmallScreen ? 0 : '10px' }} photoStyle={{height: isSmallScreen ? '60vw' : '20vw', borderTop: '5px solid #f3d2c1', backgroundColor: 'secondary.main'}} title='Maria Pinina' description='A global peer-to-peer ecommerce platform that connects buyers and sellers worldwide. Built with modern technologies like React, TypeScript, and Node.js, it offers a seamless, frictionless marketplace experience where users can freely trade anything from everyday items to unique collectibles.' strings={[MariaPininaOne, MariaPininaTwo, MariaPininaThree]} projectUrl='/projects/mariaPinina' slidesPerView={1} spaceBetween={50}/>
            </ImageList>
          </Box>
      </Box>
    </AppearWrapper>
