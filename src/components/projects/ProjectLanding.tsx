      ...
      <Box sx={{width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', bgcolor: 'background.default', fontFamily: 'Proxima-Nova', padding: '2vw'}}>
          ...
          <Box sx={{display: 'flex'}}>
            <ImageList sx={{width: '100%'}} cols={2} gap={100}>
                ...
                <ProjectBox title='Portfolio' description='This portfolio is a testament to my dedication and passion for web development. It has been created not only to highlight my skills and achievements but also to push the boundaries of my own capabilities. With a focus on interactive design and modern aesthetics, it stands as a representation of industry-leading standards.' strings={[PortfolioOne, PortfolioTwo, PortfolioThree]} projectUrl='/projects/portfolio' slidesPerView={1} spaceBetween={50}/>
            </ImageList>
          </Box>
      </Box>
    </AppearWrapper>
