...
const ProjectBox: React.FC<ProjectBoxProps> = ({ strings, title, description, projectUrl, slidesPerView, spaceBetween, sx }) => {
    ...
    return (
      <Box sx={{width: '40vw', bgcolor: 'secondary.main', padding: '1vw', height: '100%', borderRadius: '10px', ...sx}}>
            <Box>
