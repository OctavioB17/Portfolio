...
const ProjectBox: React.FC<ProjectBoxProps> = ({ strings, title, description, projectUrl }) => {
    ...
    return (
      <Box sx={{width: '50vw', bgcolor: 'secondary.main', padding: '1vw', height: '100%', borderRadius: '10px'}}>
            <Box>
                <ImageSlider strings={strings}/>
            </Box>        
