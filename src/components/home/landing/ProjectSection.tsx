...
import McFlyOne from '../../../assets/images/McFly/Grabación 2025-01-24 110048.gif'
import McFlyTwo from '../../../assets/images/McFly/Grabación 2025-01-24 110205.gif'
import McFlyThree from '../../../assets/images/McFly/Grabación 2025-01-24 111236.gif'
import McFlyFour from '../../../assets/images/McFly/Grabación 2025-01-24 111413.gif'
import EReduxOne from '../../../assets/images/ERedux/1701862669755.gif'
import EReduxTwo from '../../../assets/images/ERedux/1701862737080.gif'
import EReduxThree from '../../../assets/images/ERedux/1701862760832.gif'
import EReduxFour from '../../../assets/images/ERedux/1701862760832.gif'
import CulzoniOne from '../../../assets/images/Culzoni/Grabación-2025-01-24-124334.gif'
import CulzoniTwo from '../../../assets/images/Culzoni/Grabación-2025-01-24-124555.gif'
import CulzoniThree from '../../../assets/images/Culzoni/Grabación-2025-01-24-124821.gif'
import CulzoniFour from '../../../assets/images/Culzoni/Grabación-2025-01-24-125339.gif'
import CulzoniFive from '../../../assets/images/Culzoni/Grabación-2025-01-24-125448.gif'
  ...
  return (
    <Box sx={{width: '100vw', bgcolor: 'primary.main', padding: '5vw', paddingTop: '3vw', display: 'flex', flexDirection: 'column', gap: '3vw' }}>
      <Typography variant='h2' sx={{color: 'button.main', fontWeight: '600', textDecoration: 'underline', display: 'inline'}}>
        <Typography variant='h2' sx={{fontWeight: 600, color: 'quaternary.main', display: 'inline'}}>My</Typography><Typography variant='h2' sx={{fontWeight: 600, color: 'quaternary.main', display: 'inline'}}> Projects</Typography>
      </Typography>
      <Box sx={{display: 'flex'}}>
