...
const PresentationBanner = () => {
  ...
  return (
  <>
    <SectionWithPhoto imgUrl={'/src/assets/images/Octavio-Bruza.jpg'} imgDirection='Right' photoSx={{borderRadius: '100%', width: '30vw'}} sx={{width: '100vw', backgroundColor: 'secondary.main', padding: '10vw'}}>
